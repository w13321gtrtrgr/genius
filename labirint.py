...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet('stone .png', self.rect.right, self.rect.centery, 15, 20, 15)
        bullets.add(bullet)
...
final_sprite = GameSprite('block.png', win_width - 85, win_height - 100, 80, 80)


monster1 = Enemy('boar_003.png', win_width - 80, 150, 80, 80, 5)
monster2 = Enemy('boar_003.png', win_width - 80, 230, 80, 80, 5)
